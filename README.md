...
--#region Auto Farm Tab
        ...
        autoloadtab:Toggle("Auto Load Script", getgenv().AutoLoadTP, function(bool)
            queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/bonusking007/Anime-adventure/main/README.md'))()")
...
if getgenv().AutoLoadTP == true then
    queue_on_teleport("https://raw.githubusercontent.com/bonusking007/Anime-adventure/main/README.md'))()")
end
